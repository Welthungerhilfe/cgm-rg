...
def post_weight_result_object(artifacts, predictions, workflow_id, scan_id):
...
def main(req: func.HttpRequest,
    ...
    try:
        if scan_metadata:
            ...
            weight_plaincnn_workflow_id = ml_api.get_workflow_id(workflow_name, workflow_version)
            logging.info(f"starting height RG for scan id {scan_id}, {weight_plaincnn_workflow_id}")
            ...
            post_weight_result_object(depth_artifacts, predictions, weight_plaincnn_workflow_id, scan_id)
