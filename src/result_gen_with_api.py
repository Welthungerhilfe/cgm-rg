...
class DepthMapImgFlow:
    ...
    def post_result_object(self):
        ...
        depthmap_img_result_object = self.bunch_object_to_json_object(depthmap_img_result)
...
def main():
    ...
    if get_scan_metadata.get_unprocessed_scans() > 0:
        ...
        depthmap_img_flow = DepthMapImgFlow(cgm_api, workflow, depthmap_img_workflow_path, depth_artifacts, scan_parent_dir, scan_metadata)
