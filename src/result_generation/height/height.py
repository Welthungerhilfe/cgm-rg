...
class HeightFlow:
    ...
    def post_height_results(self, predictions, generated_timestamp):
        ...
        self.post_artifact_level_height_results(predictions, generated_timestamp)
        self.post_scan_level_height_results(predictions, generated_timestamp)

    def post_artifact_level_height_results(self, predictions, generated_timestamp):
        """Post scan level height results to the API"""
    ...
    def post_scan_level_height_results(self, predictions, generated_timestamp):
        """Post scan level height results to the API"""
