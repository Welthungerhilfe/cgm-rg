...
class HeightFlowDeepEnsemble(HeightFlow):
    def run_height_flow_deepensemble(self):
        ...
        prediction_list_one = []
        model_paths =  glob.glob('/Users/prajwalsingh/cgm-rg/models/deepensemble/*')
        for model_index, model_path in enumerate(model_paths):
            prediction_list_one += [inference.get_ensemble_height_predictions_local(model_path, depthmaps)]
        ...
        self.post_height_results_deep_ensemble(prediction_list_one, generated_timestamp,std)
