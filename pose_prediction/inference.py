...
import pose_prediction.code.models.pose_hrnet  # noqa
from pose_prediction.code.config import cfg, update_config
from pose_prediction.code.config.constants import (COCO_KEYPOINT_INDEXES, NUM_KPTS)
from pose_prediction.code.models.pose_hrnet import get_pose_net
from pose_prediction.code.utils.utils import (box_to_center_scale, calculate_pose_score, draw_pose, get_person_detection_boxes, get_pose_estimation_prediction, rot)
...
class PosePrediction:
    ...
    def load_pose_model(self):
        ...
        model_file_path = str(cfg.TEST.MODEL_FILE)
    ...
    def read_image(self, file_id, ml_api):
...
class ResultGeneration:
    ...
    def result_on_artifact_level(self, file_id, scan_type, ml_api):

        original_image, shape = self.pose_prediction.read_image(file_id, ml_api)
...
def init_pose_prediction():
    ...
    args = str('./pose_prediction/inference-config-hrnet.yaml')
...
def inference_artifact(pose_prediction, file_id, scan_type, ml_api):
