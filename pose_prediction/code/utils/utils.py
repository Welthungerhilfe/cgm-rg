...
from pose_prediction.code.config import cfg
from pose_prediction.code.config.constants import COCO_INSTANCE_CATEGORY_NAMES, NUM_KPTS, SKELETON, CocoColors
from pose_prediction.code.utils.post_processing import get_final_preds
from pose_prediction.code.utils.transforms import get_affine_transform
